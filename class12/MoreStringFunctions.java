...
public class MoreStringFunctions {
	...
	public static void main(String[] args) {
		        ...
		        me=me.replace("Great", "Awesome");//not going to do anything bc it did not find great in string
		        System.out.println(me);//we get back same string
		        ...
		        str2=str2.replaceAll("[^A-Za-z0-9]", "");//^means not replace
		        System.out.println(str2);
		        
		        
		        String subject="Java";
		        //find a replace with e, find j replace with i
